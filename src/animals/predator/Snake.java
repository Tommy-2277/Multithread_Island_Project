...
public class Snake extends Predator {
    ...
    public Snake(int x, int y, String name) throws IOException {
        super(x, y, name);
    }

    {
        try {
            properties.load(new FileInputStream("src\\config\\snake.properties"));
    ...
    public void eat() throws IOException {
        ...
        synchronized (getIsland()[zoneCoordinates[0]][zoneCoordinates[1]].getAnimals()) {
            ...
            this.setHungryLevel(this.getHungryLevel() - 0.5);
        }
    }
