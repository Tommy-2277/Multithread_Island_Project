...
public class Goat extends Herbivore {
    ...
    public Goat(int x, int y, String name) throws IOException {
        super(x, y, name);
    }

    {
        try {
            properties.load(new FileInputStream("src\\config\\goat.properties"));
    ...
    public void eat() throws IOException {
        ...
        this.setHungryLevel(this.getHungryLevel() - 1.5);
    }
}
