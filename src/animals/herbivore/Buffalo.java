...
public class Buffalo extends Herbivore {
    ...
    public Buffalo(int x, int y, String name) throws IOException {
        super(x, y, name);
    }

    {
        try {
            properties.load(new FileInputStream("src\\config\\buffalo.properties"));
    ...
    public void eat() throws IOException {
        ...
        this.setHungryLevel(this.getHungryLevel() - 15);
    }
}
