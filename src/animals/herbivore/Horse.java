...
public class Horse extends Herbivore {
    ...
    public Horse(int x, int y, String name) throws IOException {
        super(x, y, name);
    }

    {
        try {
            properties.load(new FileInputStream("src\\config\\horse.properties"));
    ...
    public void eat() throws IOException {
        ...
        this.setHungryLevel(this.getHungryLevel() - 9);
    }
}
