...
public class Sheep extends Herbivore {
    ...
    public Sheep(int x, int y, String name) throws IOException {
        super(x, y, name);
    }

    {
        try {
            properties.load(new FileInputStream("src\\config\\sheep.properties"));
    ...
    public void eat() throws IOException {
        ...
        this.setHungryLevel(this.getHungryLevel() - 2);
    }
}
